    ...
    return (
        <div className="relative" ref={ref}>
            <button
                ...
                className="flex h-10 min-w-0 max-w-[42vw] items-center gap-2 rounded-lg border border-[#e3e3e3] bg-white px-3 text-sm font-medium text-slate-800 transition-colors hover:bg-[#f8f8f8] sm:max-w-[200px]"
            >
            ...
            {isOpen && (
                <div className="absolute left-0 mt-2 w-[min(calc(100vw-1.5rem),18rem)] bg-white rounded-xl shadow-lg border border-[#e3e3e3] z-50 overflow-hidden">
                                    ...
                                    {confirmDeleteId === tenant.tenantId ? (
                                        ...
                                        <div className="flex items-center gap-0.5 pr-1 shrink-0">
                                            <a
                                                ...
                                                className="opacity-100 sm:opacity-0 sm:group-hover:opacity-100 w-7 h-7 sm:w-6 sm:h-6 flex items-center justify-center rounded hover:bg-slate-100 text-slate-400 hover:text-slate-700 transition-all"
                                            >
                                                <ExternalLink className="w-3.5 h-3.5" />
                                            </a>
                                            <button
                                                onClick={(e) => { e.stopPropagation(); setConfirmDeleteId(tenant.tenantId); }}
                                                className="opacity-100 sm:opacity-0 sm:group-hover:opacity-100 w-7 h-7 sm:w-6 sm:h-6 flex items-center justify-center rounded hover:bg-red-50 text-slate-400 hover:text-red-500 transition-all shrink-0"
                                                title="Delete store"
                                            >
